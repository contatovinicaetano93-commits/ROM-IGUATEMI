  ...
  try {
    ...
    return ok({
      ...
      cron: {
        ...
        full: {
          schedule: 'ops/agenda/catalog 2×/dia + retry horário (offset BR)',
          mode: 'full',
        ...
        cadence:
          'fast ~20 min (offset BR) · full fatiado 2×/dia + retry horário (min-gap) · estoque horário · token 3h · purge diário — webhook só fast',
      },
      last,
